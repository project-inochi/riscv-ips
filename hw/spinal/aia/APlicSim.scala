...
object APlicSim extends App {
  ...
  compile.doSim{ dut =>
    ...
    val prioArray = Seq(SimUInt32(0x1),
                        SimUInt32(0x1),
                        SimUInt32(0x4),
                        SimUInt32(0x5),
                        SimUInt32(0x6),
    ...
    print(agent.putFullData(0, aplicmap.setieOffset, SimUInt32(0xffffffff)))
    ...
    val setipdata = SimUInt32(0x0)
    print(agent.putFullData(0, aplicmap.setipOffset, setipdata))

    val domaincfgdata = SimUInt32(0x80000100)
    print(agent.putFullData(0, aplicmap.domaincfgOffset, domaincfgdata))

    // set/clripnum
    print(agent.putFullData(0, aplicmap.setipnumOffset, SimUInt32(0x1)))
    dut.clockDomain.waitRisingEdge(10)
    print(agent.putFullData(0, aplicmap.setipnumOffset, SimUInt32(0x2)))
    dut.clockDomain.waitRisingEdge(10)
    print(agent.putFullData(0, aplicmap.clripnumOffset, SimUInt32(0x1)))
    print(agent.get(0, aplicmap.idcOffset + aplicmap.claimiOffset, 4))

    // setip and the block of setip(num) when mode is high or low
    print(agent.putFullData(0, aplicmap.setipnumOffset, SimUInt32(0x5)))
    print(agent.putFullData(0, aplicmap.setipnumOffset, SimUInt32(0x6)))
    print(agent.putFullData(0, aplicmap.setipnumOffset, SimUInt32(0x7)))
    print(agent.putFullData(0, aplicmap.setipOffset, SimUInt32(0b11111100)))
    print(agent.get(0, aplicmap.idcOffset + aplicmap.claimiOffset, 4))
    print(agent.putFullData(0, aplicmap.sourcecfgOffset + 20, SimUInt32(0x1)))
    print(agent.putFullData(0, aplicmap.setipOffset, SimUInt32(0b1110001)))
    print(agent.get(0, aplicmap.idcOffset + aplicmap.claimiOffset, 4))
    print(agent.get(0, aplicmap.idcOffset + aplicmap.claimiOffset, 4))
    print(agent.get(0, aplicmap.idcOffset + aplicmap.claimiOffset, 4))
    print(agent.putFullData(0, aplicmap.sourcecfgOffset + 20, SimUInt32(0x6)))

    // input interupt
    print(agent.putFullData(0, aplicmap.clrienumOffset, SimUInt32(0x1)))
    dut.io.sources #= 0b0111111
    dut.clockDomain.waitRisingEdge(10)
    dut.io.sources #= 0b0110111
    print(agent.putFullData(0, aplicmap.setienumOffset, SimUInt32(0x1)))
    dut.clockDomain.waitRisingEdge(10)
    for (i <- 0 until 6){
      print(agent.get(0, aplicmap.idcOffset + aplicmap.claimiOffset, 4))
    }
